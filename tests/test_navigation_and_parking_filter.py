...
class SimplifiedNavigationTests(unittest.TestCase):
    ...
    def test_dashboard_keeps_rankings_and_compact_lookup(self):
        ...
        self.assertIn("Single-game history", text)
        ...
        self.assertIn("Cheapest sections", dashboard)
        ...
        self.assertNotIn("fell 20%+", dashboard)
        self.assertNotIn("How these rankings work", dashboard)
        self.assertNotIn("Preseason excluded", dashboard)
        self.assertNotIn("Areas analyzed", dashboard)
